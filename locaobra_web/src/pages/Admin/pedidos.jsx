...
function AdminPedidos() {
  ...
  const [modalRecusa, setModalRecusa] = useState(null); // { pedidoId, tipo: 'recusar' }
        ...
        <div className="recentUsersSection">
          <div className="sectionHeader">
            <h3>
              ...
              {aba === 'consultor' ? 'Solicitações' : 'Prontos p/ Expedição'}
            </h3>
          </div>
            ...
            <table className="usersTable">
              ...
              <tbody>
                {pedidos.map((pedido) => {
                  ...
                  return (
                    <tr key={pedido.id} className="tableRow">
                      <td className="nameCell">
                        <div className="userCell">
                          <div className="userCellAvatar pedidoAvatar">
                            <FontAwesomeIcon icon={faBoxOpen} />
                          </div>
                          <div>
                            <div className="userName">{pedido.codigo}</div>
                            <div className="userRole">
                              {/* {pedido.enderecoEntrega?.formatado || 'Sem endereço'} */}
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      {/*<td>
                        {(pedido.itens || [])
                          .map((i) => `${i.equipamentoNome} ×${i.quantidade}`)
                          .join(', ') || '---'}
                      </td>*/}
                      <td className="dateCell">
