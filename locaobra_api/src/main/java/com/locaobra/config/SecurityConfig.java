    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Blog institucional: leitura pública dos artigos (home, listagem e página do artigo).
                .requestMatchers(HttpMethod.GET, "/api/artigos", "/api/artigos/*", "/api/artigos/slug/*").permitAll()
                ...
                // ===================== ARTIGOS (blog) =====================
                // Leitura já liberada acima (público). Criar/editar/excluir é gestão de conteúdo.
                .requestMatchers("/api/artigos/**").hasAnyRole("ADMIN", "GERENTE_OPERACOES")
